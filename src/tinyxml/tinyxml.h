...
class TiXmlElement : public TiXmlNode
{
  public:
    ...
    */
    void SetAttribute(const char* name, const char* cvalue);
...
// Used to be public [internal use]
    ...
    */
    const char* ReadValue(const char* p, TiXmlParsingData* prevData, TiXmlEncoding encoding);
...
class TiXmlDocument : public TiXmlNode
{
  public:
    ...
    */
    ...
    // [internal use]
    void SetError(int err, const char* pError, TiXmlParsingData* prevData, TiXmlEncoding encoding);
