...
class sensor
{
  ...
  protected:
    ...
    */
    [[nodiscard]] virtual bool is_within_detection_cone(const vector2& r, const angle& h) const;
  ...
  public:
    ...
    */
    sensor(double range = 0.0f, double detection_cone = 360.0f);
    /// Destructor
    ...
    */
    [[nodiscard]] virtual double get_detection_cone() const { return detection_cone; }
    /**
