...
class event_depth_charge_in_water : public event
{
  ...
  public:
    event_depth_charge_in_water(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_depth_charge_exploding : public event
{
  ...
  public:
    event_depth_charge_exploding(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_gunfire_light : public event
{
  ...
  public:
    event_gunfire_light(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_gunfire_medium : public event
{
  ...
  public:
    event_gunfire_medium(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_gunfire_heavy : public event
{
  ...
  public:
    event_gunfire_heavy(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_shell_explosion : public event
{
  ...
  public:
    event_shell_explosion(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_shell_splash : public event
{
  ...
  public:
    event_shell_splash(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_ship_collision : public event
{
  ...
  public:
    event_ship_collision(const vector3& p)
        : position(p)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_torpedo_explosion : public event
{
  ...
  public:
    event_torpedo_explosion(const vector3& src)
        : source(src)
    {
    }
    void evaluate(user_interface& ui) override;
...
class event_tube_reloaded : public event
{
  ...
  public:
    event_tube_reloaded(unsigned nr)
        : tube_nr(nr)
    {
    }
    void evaluate(user_interface& ui) override;
