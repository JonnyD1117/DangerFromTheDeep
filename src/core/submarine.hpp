...
class submarine : public ship
{
  ...
  protected:
    ...
    */
    ...
    {
        return (1.0f - (battery_recharge_value_a * exp(-get_throttle_speed() / battery_recharge_value_t)));
    }
  ...
  public:
    ...
    */
    ...
    submarine(date game_date, object_store<model>& model_store, const xml_elem& parent);
    ...
    [[nodiscard]] const std::vector<stored_torpedo>& get_torpedoes() const { return torpedoes; }
    ...
    [[nodiscard]] virtual unsigned get_nr_of_bow_tubes() const { return number_of_tubes_at[0]; }
    [[nodiscard]] virtual unsigned get_nr_of_stern_tubes() const { return number_of_tubes_at[1]; }
    [[nodiscard]] virtual unsigned get_nr_of_bow_reserve() const { return number_of_tubes_at[2]; }
    [[nodiscard]] virtual unsigned get_nr_of_stern_reserve() const { return number_of_tubes_at[3]; }
    [[nodiscard]] virtual unsigned get_nr_of_bow_deckreserve() const { return number_of_tubes_at[4]; }
    [[nodiscard]] virtual unsigned get_nr_of_stern_deckreserve() const { return number_of_tubes_at[5]; }
    ...
    [[nodiscard]] std::pair<unsigned, unsigned> get_stern_reserve_indices() const;
    [[nodiscard]] std::pair<unsigned, unsigned> get_bow_deckreserve_indices() const;
    [[nodiscard]] std::pair<unsigned, unsigned> get_stern_deckreserve_indices() const;
    [[nodiscard]] unsigned
    get_location_by_tubenr(unsigned tn) const; // returns 1-6 as location number, 0 if not supported
    ...
    [[nodiscard]] float surface_visibility(const vector2& watcher) const override;
    ...
    [[nodiscard]] virtual const stored_torpedo& get_torp_in_tube(unsigned tubenr) const;
    [[nodiscard]] virtual bool is_scope_up() const { return scope_raise_level >= 0.8f; }
    [[nodiscard]] virtual float get_scope_raise_level() const { return scope_raise_level; }
    [[nodiscard]] virtual double get_periscope_depth() const { return periscope_depth; }
    [[nodiscard]] virtual bool is_submerged() const { return dive_state == dive_state_diving; }
    [[nodiscard]] virtual double get_max_depth() const { return max_depth; }
    [[nodiscard]] virtual bool is_electric_engine() const { return (electric_engine == true); }
    [[nodiscard]] virtual bool is_snorkel_up() const { return (snorkelup == true); }
    [[nodiscard]] virtual bool has_snorkel() const { return (hassnorkel == true); }
    [[nodiscard]] virtual double get_snorkel_depth() const { return snorkel_depth; }
    [[nodiscard]] virtual double get_alarm_depth() const { return alarm_depth; }
    [[nodiscard]] virtual double get_battery_level() const { return battery_level; }
    [[nodiscard]] virtual const std::vector<part>& get_damage_status() const { return parts; }

    // get/compute torpedo transfer time and helper functions (uses functions
    // below to compute)
    [[nodiscard]] virtual double get_torp_transfer_time(unsigned from, unsigned to) const;
    [[nodiscard]] virtual double get_bow_reload_time() const { return torp_transfer_times[0]; }
    [[nodiscard]] virtual double get_stern_reload_time() const { return torp_transfer_times[1]; }
    [[nodiscard]] virtual double get_bow_deck_reload_time() const { return torp_transfer_times[2]; }
    [[nodiscard]] virtual double get_stern_deck_reload_time() const { return torp_transfer_times[3]; }
    [[nodiscard]] virtual double get_bow_stern_deck_transfer_time() const { return torp_transfer_times[4]; }
    ...
    virtual bool set_snorkel_up(bool snorkelup); // fixme get rid of this
    virtual void snorkel_up() { set_snorkel_up(true); }
    virtual void snorkel_down() { set_snorkel_up(false); }
    virtual void set_planes_to(double amount,
    ...
    [[nodiscard]] virtual const sonar_operator& get_sonarman() const { return sonarman; }

    [[nodiscard]] virtual double get_bow_rudder() const { return bow_depth_rudder.angle; }
    [[nodiscard]] virtual double get_stern_rudder() const { return stern_depth_rudder.angle; }
    [[nodiscard]] virtual double get_bow_rudder_max_angle() const { return bow_depth_rudder.max_angle; }
    [[nodiscard]] virtual double get_stern_rudder_max_angle() const { return stern_depth_rudder.max_angle; }
    ...
    [[nodiscard]] const std::string& get_torpedomanage_img_name() const { return torpedomanage_sidetopimg; }

    [[nodiscard]] virtual hearing_device_type get_hearing_device_type() const { return hearing_device; }
