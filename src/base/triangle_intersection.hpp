    ...
    const T eps = T(1e-5))
{
    ...
    if (delta0_legal) {
        ...
        if (delta1_legal) {
            ...
            PRINT_TRICOL(
                "p0: " << p0 << " p1: " << p1 << " q0: " << q0 << " q1: " << q1 << " det " << detAr << "," << detAq0
                       << "," << detAq1 << "\n");

            return ((gamma0 >= nullT) && (gamma0 <= dy2)) || ((gamma1 >= nullT) && (gamma1 <= dx2))
                   || (gamma0 * gamma1 < 0);
        } else {
            T dxpdy  = d.x + d.y;
            ...
            PRINT_TRICOL(
                "gamma0=" << gamma0 << " gamma2=" << gamma2 << " dy2=" << dy2 << " dxpdy*dxpdy=" << dxpdy * dxpdy
                          << "\n");
            ...
            return ((gamma0 >= nullT) && (gamma0 <= dy2)) || ((gamma2 >= nullT) && (gamma2 <= dxpdy * dxpdy))
                   || (gamma0 * gamma2 < 0);
        }
        ...
        PRINT_TRICOL(
            "gamma1=" << gamma1 << " gamma2=" << gamma2 << " dx2=" << dx2 << " dxpdy*dxpdy=" << dxpdy * dxpdy << "\n");
        ...
        return ((gamma1 >= nullT) && (gamma1 <= dx2)) || ((gamma2 >= nullT) && (gamma2 <= dxpdy * dxpdy))
               || (gamma1 * gamma2 < 0);
    }
    return false;
}
