...
class CRenderingContext
{
  ...
  protected:
    ...
    static bool InitVersion12(); //                     GL_VERSION_1_2
    static bool InitVersion13(); //                     GL_VERSION_1_3
    static bool InitVersion14(); //                     GL_VERSION_1_4
    static bool InitVersion15(); //                     GL_VERSION_1_5
    static bool InitVersion20(); //                     GL_VERSION_2_0

    static bool Init3dfxTbuffer();                //                    GL_3DFX_tbuffer
    static bool InitAppleElementArray();          //             GL_APPLE_element_array
    static bool InitAppleFence();                 //                     GL_APPLE_fence
    static bool InitAppleVertexArrayObject();     //       GL_APPLE_vertex_array_object
    static bool InitAppleVertexArrayRange();      //        GL_APPLE_vertex_array_range
    static bool InitArbColorBufferFloat();        //          GL_ARB_color_buffer_float
    static bool InitArbDrawBuffers();             //                GL_ARB_draw_buffers
    static bool InitArbMatrixPalette();           //              GL_ARB_matrix_palette
    static bool InitArbMultisample();             //                 GL_ARB_multisample
    static bool InitArbMultitexture();            //                GL_ARB_multitexture
    static bool InitArbOcclusionQuery();          //             GL_ARB_occlusion_query
    static bool InitArbPointParameters();         //            GL_ARB_point_parameters
    static bool InitArbShaderObjects();           //              GL_ARB_shader_objects
    static bool InitArbTextureCompression();      //         GL_ARB_texture_compression
    static bool InitArbTransposeMatrix();         //            GL_ARB_transpose_matrix
    static bool InitArbVertexBlend();             //                GL_ARB_vertex_blend
    static bool InitArbVertexBufferObject();      //        GL_ARB_vertex_buffer_object
    static bool InitArbVertexProgram();           //              GL_ARB_vertex_program
    static bool InitArbVertexShader();            //               GL_ARB_vertex_shader
    static bool InitArbWindowPos();               //                  GL_ARB_window_pos
    static bool InitAtiDrawBuffers();             //                GL_ATI_draw_buffers
    static bool InitAtiElementArray();            //               GL_ATI_element_array
    static bool InitAtiEnvmapBumpmap();           //              GL_ATI_envmap_bumpmap
    static bool InitAtiFragmentShader();          //             GL_ATI_fragment_shader
    static bool InitAtiMapObjectBuffer();         //           GL_ATI_map_object_buffer
    static bool InitAtiPnTriangles();             //                GL_ATI_pn_triangles
    static bool InitAtiSeparateStencil();         //            GL_ATI_separate_stencil
    static bool InitAtiVertexArrayObject();       //         GL_ATI_vertex_array_object
    static bool InitAtiVertexAttribArrayObject(); //  GL_ATI_vertex_attrib_array_object
    static bool InitAtiVertexStreams();           //              GL_ATI_vertex_streams
    static bool InitExtBlendColor();              //                 GL_EXT_blend_color
    static bool InitExtBlendEquationSeparate();   //     GL_EXT_blend_equation_separate
    static bool InitExtBlendFuncSeparate();       //         GL_EXT_blend_func_separate
    static bool InitExtBlendMinmax();             //                GL_EXT_blend_minmax
    static bool InitExtColorSubtable();           //              GL_EXT_color_subtable
    static bool InitExtCompiledVertexArray();     //       GL_EXT_compiled_vertex_array
    static bool InitExtConvolution();             //                 GL_EXT_convolution
    static bool InitExtCoordinateFrame();         //            GL_EXT_coordinate_frame
    static bool InitExtCopyTexture();             //                GL_EXT_copy_texture
    static bool InitExtCullVertex();              //                 GL_EXT_cull_vertex
    static bool InitExtDepthBoundsTest();         //           GL_EXT_depth_bounds_test
    static bool InitExtDrawRangeElements();       //         GL_EXT_draw_range_elements
    static bool InitExtFogCoord();                //                   GL_EXT_fog_coord
    static bool InitExtFramebufferObject();       //          GL_EXT_framebuffer_object
    static bool InitExtHistogram();               //                   GL_EXT_histogram
    static bool InitExtIndexFunc();               //                  GL_EXT_index_func
    static bool InitExtIndexMaterial();           //              GL_EXT_index_material
    static bool InitExtLightTexture();            //               GL_EXT_light_texture
    static bool InitExtMultiDrawArrays();         //           GL_EXT_multi_draw_arrays
    static bool InitExtMultisample();             //                 GL_EXT_multisample
    static bool InitExtPalettedTexture();         //            GL_EXT_paletted_texture
    static bool InitExtPixelTransform();          //             GL_EXT_pixel_transform
    static bool InitExtPointParameters();         //            GL_EXT_point_parameters
    static bool InitExtPolygonOffset();           //              GL_EXT_polygon_offset
    static bool InitExtSecondaryColor();          //             GL_EXT_secondary_color
    static bool InitExtStencilTwoSide();          //            GL_EXT_stencil_two_side
    static bool InitExtSubtexture();              //                  GL_EXT_subtexture
    static bool InitExtTexture3d();               //                   GL_EXT_texture3D
    static bool InitExtTextureObject();           //              GL_EXT_texture_object
    static bool InitExtTexturePerturbNormal();    //      GL_EXT_texture_perturb_normal
    static bool InitExtVertexArray();             //                GL_EXT_vertex_array
    static bool InitExtVertexShader();            //               GL_EXT_vertex_shader
    static bool InitExtVertexWeighting();         //            GL_EXT_vertex_weighting
    static bool InitGremedyStringMarker();        //           GL_GREMEDY_string_marker
    static bool InitHpImageTransform();           //              GL_HP_image_transform
    static bool InitIbmMultimodeDrawArrays();     //       GL_IBM_multimode_draw_arrays
    static bool InitIbmVertexArrayLists();        //          GL_IBM_vertex_array_lists
    static bool InitIngrBlendFuncSeparate();      //        GL_INGR_blend_func_separate
    static bool InitIntelParallelArrays();        //           GL_INTEL_parallel_arrays
    static bool InitMesaResizeBuffers();          //             GL_MESA_resize_buffers
    static bool InitMesaWindowPos();              //                 GL_MESA_window_pos
    bool InitNvElementArray();                    //                GL_NV_element_array
    static bool InitNvEvaluators();               //                   GL_NV_evaluators
    static bool InitNvFence();                    //                        GL_NV_fence
    static bool InitNvFragmentProgram();          //             GL_NV_fragment_program
    static bool InitNvHalfFloat();                //                   GL_NV_half_float
    static bool InitNvOcclusionQuery();           //              GL_NV_occlusion_query
    static bool InitNvPixelDataRange();           //             GL_NV_pixel_data_range
    static bool InitNvPointSprite();              //                 GL_NV_point_sprite
    static bool InitNvPrimitiveRestart();         //            GL_NV_primitive_restart
    static bool InitNvRegisterCombiners();        //           GL_NV_register_combiners
    static bool InitNvRegisterCombiners2();       //          GL_NV_register_combiners2
    bool InitNvStencilTwoSide();                  //             GL_NV_stencil_two_side
    static bool InitNvVertexArrayRange();         //           GL_NV_vertex_array_range
    static bool InitNvVertexProgram();            //               GL_NV_vertex_program
    static bool InitNvxConditionalRender();       //          GL_NVX_conditional_render
    static bool InitPgiMiscHints();               //                  GL_PGI_misc_hints
    static bool InitSgiColorTable();              //                 GL_SGI_color_table
    static bool InitSgisDetailTexture();          //             GL_SGIS_detail_texture
    static bool InitSgisFogFunction();            //               GL_SGIS_fog_function
    static bool InitSgisMultisample();            //                GL_SGIS_multisample
    static bool InitSgisPixelTexture();           //              GL_SGIS_pixel_texture
    static bool InitSgisPointParameters();        //           GL_SGIS_point_parameters
    static bool InitSgisSharpenTexture();         //            GL_SGIS_sharpen_texture
    static bool InitSgisTexture4d();              //                  GL_SGIS_texture4D
    static bool InitSgisTextureColorMask();       //         GL_SGIS_texture_color_mask
    static bool InitSgisTextureFilter4();         //            GL_SGIS_texture_filter4
    static bool InitSgixAsync();                  //                      GL_SGIX_async
    static bool InitSgixFlushRaster();            //               GL_SGIX_flush_raster
    static bool InitSgixFragmentLighting();       //          GL_SGIX_fragment_lighting
    static bool InitSgixFramezoom();              //                  GL_SGIX_framezoom
    static bool InitSgixIglooInterface();         //            GL_SGIX_igloo_interface
    static bool InitSgixInstruments();            //                GL_SGIX_instruments
    static bool InitSgixListPriority();           //              GL_SGIX_list_priority
    static bool InitSgixPixelTexture();           //              GL_SGIX_pixel_texture
    static bool InitSgixPolynomialFfd();          //             GL_SGIX_polynomial_ffd
    static bool InitSgixReferencePlane();         //            GL_SGIX_reference_plane
    static bool InitSgixSprite();                 //                     GL_SGIX_sprite
    static bool InitSgixTagSampleBuffer();        //          GL_SGIX_tag_sample_buffer
    static bool InitSunGlobalAlpha();             //                GL_SUN_global_alpha
    static bool InitSunMeshArray();               //                  GL_SUN_mesh_array
    static bool InitSunTriangleList();            //               GL_SUN_triangle_list
    static bool InitSunVertex();                  //                      GL_SUN_vertex
    static bool InitSunxConstantData();           //              GL_SUNX_constant_data
  ...
  public:
    ...
    GLvoid(
        APIENTRY* m_pSeparableFilter2D)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*, GLvoid const*);
    GLvoid(
        APIENTRY* m_pTexImage3D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid const*);
    ...
    GLvoid(
        APIENTRY*
            m_pCompressedTexImage3D)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, GLvoid const*);
    GLvoid(APIENTRY* m_pCompressedTexSubImage1D)(GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, GLvoid const*);
    GLvoid(
        APIENTRY*
            m_pCompressedTexSubImage2D)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, GLvoid const*);
    ...
    GLvoid(
        APIENTRY* m_pCompressedTexImage2DARB)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, GLvoid const*);
    ...
    GLvoid(APIENTRY*
               m_pColorFragmentOp2ATI)(GLenum, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint);
    ...
    GLvoid(APIENTRY*
               m_pSeparableFilter2DEXT)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*, GLvoid const*);
    ...
    GLvoid(
        APIENTRY*
            m_pTexImage3DEXT)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid const*);
    ...
    GLvoid(APIENTRY*
               m_pMapControlPointsNV)(GLenum, GLuint, GLenum, GLsizei, GLsizei, GLint, GLint, GLboolean, GLvoid const*);
    ...
    GLvoid(APIENTRY*
               m_pProgramNamedParameter4dNV)(GLuint, GLsizei, GLubyte const*, GLdouble, GLdouble, GLdouble, GLdouble);
    ...
    GLvoid(
        APIENTRY* m_pReplacementCodeuiColor3fVertex3fSUN)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
    ...
    GLvoid(APIENTRY*
               m_pReplacementCodeuiNormal3fVertex3fSUN)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
    ...
    GLvoid(APIENTRY*
               m_pTexCoord2fColor3fVertex3fSUN)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
    ...
    GLvoid(
        APIENTRY*
            m_pTexCoord2fNormal3fVertex3fSUN)(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
