...
GLAPI GLvoid
glTexSubImage3D(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*);
...
GLAPI
GLvoid glDrawRangeElementArrayAPPLE(GLenum, GLuint, GLuint, GLint, GLsizei);
...
GLAPI
GLvoid glMultiTexCoord4dARB(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
...
GLAPI GLvoid
glCompressedTexSubImage2DARB(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, GLvoid const*);
...
GLAPI
GLvoid glVertexStream4dATI(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
...
GLAPI
GLvoid glCopyConvolutionFilter1DEXT(GLenum, GLenum, GLint, GLint, GLsizei);
...
GLAPI
GLvoid glCopyTexSubImage1DEXT(GLenum, GLint, GLint, GLint, GLint, GLsizei);
...
GLAPI GLvoid
glTexSubImage3DEXT(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*);
...
GLAPI
GLvoid glMultiTexCoord4hNV(GLenum, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
...
GLAPI
GLvoid glCombinerOutputNV(GLenum, GLenum, GLenum, GLenum, GLenum, GLenum, GLenum, GLboolean, GLboolean, GLboolean);
...
GLAPI GLvoid
glTexImage4DSGIS(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid const*);
...
GLAPI GLvoid glReplacementCodeuiColor4fNormal3fVertex3fSUN(
    ...
    GLfloat);
GLAPI GLvoid
glReplacementCodeuiColor4fNormal3fVertex3fvSUN(GLuint const*, GLfloat const*, GLfloat const*, GLfloat const*);
GLAPI GLvoid
...
GLAPI GLvoid glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN(
    ...
    GLfloat);
GLAPI GLvoid
glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN(GLuint const*, GLfloat const*, GLfloat const*, GLfloat const*);
...
GLAPI
GLvoid glTexCoord2fVertex3fSUN(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
