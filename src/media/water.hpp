...
class water
{
  protected:
    ...
    struct wavetile_phase
    {
        struct mipmap_level
        {
            ...
            mipmap_level(const std::vector<vector3f>& wd, unsigned res_shift, double sampledist);
            ...
            [[nodiscard]] const vector3f& get_normal(unsigned x, unsigned y) const
            {
        ...
        [[nodiscard]] float get_height(unsigned idx) const { return mipmaps.front().wavedata[idx].z; }
    ...
    void setup_textures(const matrix4& reflection_projmvmat, const vector2f& transl, bool under_water) const;
    ...
    class geoclipmap_patch
    {
      ...
      public:
        ...
        geoclipmap_patch(
            ...
            unsigned border);
        void render() const;
        [[nodiscard]] unsigned get_nr_indices() const { return nr_indices; } // for analysis
  ...
  public:
    ...
    vector3f get_normal(const vector2& pos, double rollfac = 1.0) const;
