...
class glsl_program
{
  public:
    ...
    [[nodiscard]] unsigned get_vertex_attrib_index(const std::string& name) const;
...
class glsl_shader_setup
{
  public:
    ...
    void set_uniform(unsigned loc, const vector3f& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable
    void set_uniform(unsigned loc, const vector2f& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (vec2 array)
    void set_uniform(unsigned loc, const std::vector<vector2f>& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable
    void set_uniform(unsigned loc, float value) const { prog.set_uniform(loc, value); }

    /// set uniform variable
    void set_uniform(unsigned loc, double value) const { prog.set_uniform(loc, float(value)); }

    /// set uniform variable (int)
    void set_uniform(unsigned loc, signed int value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (doubles)
    void set_uniform(unsigned loc, const vector3& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (matrix4)
    void set_uniform(unsigned loc, const matrix4& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (vec4)
    void set_uniform(unsigned loc, const vector4f& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (vec4)
    void set_uniform(unsigned loc, const std::vector<vector4f>& value) const { prog.set_uniform(loc, value); }

    /// set uniform variable (vec4)
    void set_uniform(unsigned loc, const colorf& value) const { prog.set_uniform(loc, value); }
