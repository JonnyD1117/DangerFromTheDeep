...
class primitive
{
  ...
  public:
    primitive(int type_, const colorf& col_)
        : type(type_)
        , col(col_)
    {
    }
...
class primitives : public primitives_plain
{
  ...
  public:
    ...
    primitives(int type, unsigned size, const colorf& col,
               const texture& tex); // uni-color + tex
    primitives(int type, unsigned size,
    ...
    /// render a 2d quad
    static primitive<4> quad(const vector2f& xy0, const vector2f& xy1, const colorf& col);
    /// render a 2d triangle
    static primitive<3> triangle(const vector2f& xy0, const vector2f& xy1, const vector2f& xy2, const colorf& col);
    /// render a 2d rectangle
    static primitive<4> rectangle(const vector2f& xy0, const vector2f& xy1, const colorf& col);
    /// render a 2d diamond
    static primitive<4> diamond(const vector2f& xy, float r, const colorf& col);
    /// render a 2d line
    static primitive<2> line(const vector2f& xy0, const vector2f& xy1, const colorf& col);
    /// render a 2d circle
    static primitives circle(const vector2f& xy, float radius, const colorf& col);
    /// render a 3d line
    static primitive<2> line(const vector3f& xyz0, const vector3f& xyz1, const colorf& col);
