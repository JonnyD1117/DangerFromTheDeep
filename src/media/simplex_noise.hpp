...
class simplex_noise
{
  protected:
    ...
    static double dot(const int* g, double& x, double& y) { return g[0] * x + g[1] * y; }
  ...
  public:
    ...
    noise_map2D(vector2i size, unsigned ocatves = 1, float persistence = 1.0, float coord_factor = 0.01);
};
