...
class font
{
  ...
  public:
    ...
    void
    print_hc(int x, int y, const std::string& text, color col = color(255, 255, 255), bool with_shadow = false) const;

    /// Print text vertically centered
    void
    print_vc(int x, int y, const std::string& text, color col = color(255, 255, 255), bool with_shadow = false) const;

    /// Print text centered horizontally and vertically
    void
    print_c(int x, int y, const std::string& text, color col = color(255, 255, 255), bool with_shadow = false) const;
    ...
    */
    ...
    get_nr_of_lines_wrapped(unsigned w, const std::string& text, unsigned maxlines = 0) const;
    /** get width of character in pixels */
    ...
    static bool is_byte_of_multibyte_char(unsigned char c) { return (c & 0x80) != 0x00; }
