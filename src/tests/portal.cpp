...
void run()
{
    ...
    */
    ...
    glsl_reliefmapping =
        new glsl_shader_setup(get_shader_dir() + "reliefmapping.vshader", get_shader_dir() + "reliefmapping.fshader");
    glsl_reliefmapping->use();
    ...
    while (!doquit) {
        ...
        pos += forward * mv_forward * delta_t * move_speed + sideward * mv_sideward * delta_t * move_speed
